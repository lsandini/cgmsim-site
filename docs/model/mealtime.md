...
I use model to this compute the activity of each mealtime insulin dose. I selected a peak time of 60 minutes and a DIA of 300 min (5 hours!) as default, but mealtime insulins have a duration of activity closer to 180 min or 3 hours. For faster aspart (Fiasp®), you may want to choose an even shorter time-to-peak and DIA.
