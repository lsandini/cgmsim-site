...
This new version includes **pseudo-random variability based on real time astronomical calculations !** [Read further here for deatils.](model/random.md#astronomy)

The gravitational force of the planets of the Solar System, and the phase of the Moon will add a **very very tiny variation** on the model over time. This is intended to keep the user's attention on the cyclic changes and address the common joke about the cosmic influnce of the stars, planets and the Moon on one's blood sugar variations.
